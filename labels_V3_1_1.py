...
OUTPUT_DIR = os.path.expanduser("~/Documents/Testing/labelling_tk_app")
...
def _cargar_fuentes():
    try:
        ...
        logger.warning(f"No se pudo cargar la fuente Rubik en '{RUBIK_FONT_PATH}', usando fuente por defecto")
...
root = tk.Tk()
root.title("WS Labelling - Rev 3.2")
